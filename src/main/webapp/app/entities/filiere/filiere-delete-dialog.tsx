...
export const FiliereDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionDesEtudiantsApp.filiere.delete.question">
        <Translate contentKey="gestionDesEtudiantsApp.filiere.delete.question" interpolate={{ id: filiereEntity.id }}>
