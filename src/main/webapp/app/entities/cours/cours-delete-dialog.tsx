...
export const CoursDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionDesEtudiantsApp.cours.delete.question">
        <Translate contentKey="gestionDesEtudiantsApp.cours.delete.question" interpolate={{ id: coursEntity.id }}>
