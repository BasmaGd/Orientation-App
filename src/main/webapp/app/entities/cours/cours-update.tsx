  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gestionDesEtudiantsApp.cours.home.createOrEditLabel" data-cy="CoursCreateUpdateHeading">
            <Translate contentKey="gestionDesEtudiantsApp.cours.home.createOrEditLabel">Create or edit a Cours</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gestionDesEtudiantsApp.cours.nomCours')}
                id="cours-nomCours"
                name="nomCours"
                data-cy="nomCours"
                type="text"
              />
              <ValidatedField
                label={translate('gestionDesEtudiantsApp.cours.description')}
